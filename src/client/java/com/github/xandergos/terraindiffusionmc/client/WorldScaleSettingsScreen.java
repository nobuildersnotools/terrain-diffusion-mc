...
/** World creation screen for selecting the initial terrain scale. */
public final class WorldScaleSettingsScreen extends Screen {
    ...
    protected void init() {
        ...
        scaleTextField = new EditBox(this.font,
                ...
                TEXT_FIELD_WIDTH, TEXT_FIELD_HEIGHT, LABEL_TEXT);
    ...
    private WorldDimensions updateOverworldDimensionType(
        ...
        LevelStem updatedOverworldOptions = new LevelStem(selectedDimensionTypeEntry, overworldOptions.generator());
